...
// EditorIRRenderer 描述了 Editor Instant-Rendering DOM 渲染器。
type EditorIRRenderer struct {
	*BaseRenderer
}

// NewEditorIRRenderer 创建一个 Editor Instant-Rendering DOM 渲染器。
func NewEditorIRRenderer(tree *parse.Tree, options *Options) *EditorIRRenderer {
	ret := &EditorIRRenderer{BaseRenderer: NewBaseRenderer(tree, options)}
...
func (r *EditorIRRenderer) renderLinkRefDefBlock(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
...
func (r *EditorIRRenderer) renderLinkRefDef(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
...
func (r *EditorIRRenderer) renderKramdownBlockIAL(node *ast.Node, entering bool) ast.WalkStatus {
	return ast.WalkContinue
}

func (r *EditorIRRenderer) renderMark(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
...
func (r *EditorIRRenderer) renderMark1OpenMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("span", [][]string{{"class", "editor-ir__marker"}}, false)
		r.WriteString("=")
		r.Tag("/span", nil, false)
...
func (r *EditorIRRenderer) renderMark1CloseMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
...
func (r *EditorIRRenderer) renderMark2OpenMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("span", [][]string{{"class", "editor-ir__marker"}}, false)
		r.WriteString("==")
		r.Tag("/span", nil, false)
...
func (r *EditorIRRenderer) renderMark2CloseMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("/mark", nil, false)
		r.Tag("span", [][]string{{"class", "editor-ir__marker"}}, false)
		r.WriteString("==")
...
func (r *EditorIRRenderer) renderSup(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.renderSpanNode(node)
	} else {
		r.Tag("/span", nil, false)
...
func (r *EditorIRRenderer) renderSupOpenMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("span", [][]string{{"class", "editor-ir__marker"}}, false)
		r.WriteString("^")
		r.Tag("/span", nil, false)
...
func (r *EditorIRRenderer) renderSupCloseMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("/sup", nil, false)
		r.Tag("span", [][]string{{"class", "editor-ir__marker"}}, false)
		r.WriteString("^")
...
func (r *EditorIRRenderer) renderSub(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.renderSpanNode(node)
	} else {
		r.Tag("/span", nil, false)
...
func (r *EditorIRRenderer) renderSubOpenMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("span", [][]string{{"class", "editor-ir__marker"}}, false)
		r.WriteString("~")
		r.Tag("/span", nil, false)
...
func (r *EditorIRRenderer) renderSubCloseMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("/sub", nil, false)
		r.Tag("span", [][]string{{"class", "editor-ir__marker"}}, false)
		r.WriteString("~")
...
func (r *EditorIRRenderer) renderYamlFrontMatterCloseMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
...
func (r *EditorIRRenderer) renderYamlFrontMatterContent(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		node.Tokens = bytes.TrimSpace(node.Tokens)
		codeLen := len(node.Tokens)
		codeIsEmpty := 1 > codeLen || (len(editor.Caret) == codeLen && editor.Caret == string(node.Tokens))
		r.Tag("pre", [][]string{{"class", "editor-ir__marker--pre"}}, false)
...
func (r *EditorIRRenderer) renderYamlFrontMatterOpenMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
...
func (r *EditorIRRenderer) renderYamlFrontMatter(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
...
func (r *EditorIRRenderer) renderHtmlEntity(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.renderSpanNode(node)
		r.Tag("code", [][]string{{"data-newline", "1"}, {"class", "editor-ir__marker editor-ir__marker--pre"}, {"data-type", "html-entity"}}, false)
		r.Write(html.EscapeHTML(node.HtmlEntityTokens))
		r.Tag("/code", nil, false)
		r.Tag("span", [][]string{{"class", "editor-ir__preview"}, {"data-render", "2"}}, false)
		r.Tag("code", nil, false)
...
func (r *EditorIRRenderer) renderBackslashContent(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Write(html.EscapeHTML(node.Tokens))
	}
	return ast.WalkContinue
...
func (r *EditorIRRenderer) renderBackslash(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.renderSpanNode(node)
		r.Tag("span", [][]string{{"class", "editor-ir__marker editor-ir__marker--bi"}}, false)
...
func (r *EditorIRRenderer) renderToC(node *ast.Node, entering bool) ast.WalkStatus {
	return r.BaseRenderer.renderToC(node, entering)
}

func (r *EditorIRRenderer) renderFootnotesDefBlock(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
...
func (r *EditorIRRenderer) renderFootnotesDef(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
...
func (r *EditorIRRenderer) renderFootnotesRef(node *ast.Node, entering bool) ast.WalkStatus {
	if !entering {
		return ast.WalkContinue
	}
	...
	if expand {
		attrs = append(attrs, []string{"class", "editor-ir__node editor-ir__node--expand editor-tooltipped editor-tooltipped__s"})
	} else {
		attrs = append(attrs, []string{"class", "editor-ir__node editor-tooltipped editor-tooltipped__s"})
	}
	...
	r.Tag("span", [][]string{{"class", "editor-ir__marker editor-ir__marker--bracket"}}, false)
	r.WriteByte(lex.ItemOpenBracket)
	r.Tag("/span", nil, false)
	r.Tag("span", [][]string{{"class", "editor-ir__marker editor-ir__marker--link"}}, false)
	r.Write(node.Tokens)
	r.Tag("/span", nil, false)
	r.Tag("span", [][]string{{"class", "editor-ir__marker--hide"}, {"data-render", "1"}}, false)
...
func (r *EditorIRRenderer) renderCodeBlockCloseMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
...
func (r *EditorIRRenderer) renderCodeBlockInfoMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("span", [][]string{{"class", "editor-ir__marker editor-ir__marker--info"}, {"data-type", "code-block-info"}}, false)
		r.WriteString(editor.Zwsp)
...
func (r *EditorIRRenderer) renderCodeBlockOpenMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
...
func (r *EditorIRRenderer) renderCodeBlock(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.renderDivNode(node)
	} else {
		r.WriteString("</div>")
...
func (r *EditorIRRenderer) renderCodeBlockCode(node *ast.Node, entering bool) ast.WalkStatus {
	if !entering {
		return ast.WalkContinue
	}
	...
	class := "editor-ir__marker--pre"
	if r.Options.EditorCodeBlockPreview {
		class += " editor-ir__marker"
	}
	...
	if r.Options.EditorCodeBlockPreview {
		r.Tag("pre", [][]string{{"class", "editor-ir__preview"}, {"data-render", "2"}}, false)
...
func (r *EditorIRRenderer) renderEmojiAlias(node *ast.Node, entering bool) ast.WalkStatus {
	return ast.WalkContinue
}

func (r *EditorIRRenderer) renderEmojiImg(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
...
func (r *EditorIRRenderer) renderEmojiUnicode(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.WriteString("<span data-render=\"2\">")
		r.Write(node.Tokens)
		r.WriteString("</span>")
...
func (r *EditorIRRenderer) renderEmoji(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		previousNodeText := node.PreviousNodeText()
		previousNodeText = strings.ReplaceAll(previousNodeText, editor.Caret, "")
		if "" == previousNodeText {
...
func (r *EditorIRRenderer) renderInlineMathCloseMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("span", [][]string{{"class", "editor-ir__marker"}}, false)
...
func (r *EditorIRRenderer) renderInlineMathContent(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		tokens := node.Tokens
		...
		if node.ParentIs(ast.NodeTableCell) {
			// Improve the `|` render in the inline math in the table https://github.com/Vanessa219/editor/issues/1550
...
func (r *EditorIRRenderer) renderInlineMathOpenMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("span", [][]string{{"class", "editor-ir__marker"}}, false)
		r.WriteByte(lex.ItemDollar)
		r.Tag("/span", nil, false)
		r.Tag("code", [][]string{{"data-newline", "1"}, {"class", "editor-ir__marker editor-ir__marker--pre"}, {"data-type", "math-inline"}}, false)
	}
	return ast.WalkContinue
}

func (r *EditorIRRenderer) renderInlineMath(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.renderSpanNode(node)
	} else {
		r.Tag("/span", nil, false)
...
func (r *EditorIRRenderer) renderMathBlockCloseMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
...
func (r *EditorIRRenderer) renderMathBlockContent(node *ast.Node, entering bool) ast.WalkStatus {
	if !entering {
		return ast.WalkContinue
	}
	...
	codeIsEmpty := 1 > codeLen || (len(editor.Caret) == codeLen && editor.Caret == string(node.Tokens))
	class := "editor-ir__marker--pre"
	if r.Options.EditorMathBlockPreview {
		class += " editor-ir__marker"
	}
	r.Tag("pre", [][]string{{"class", class}}, false)
...
func (r *EditorIRRenderer) renderMathBlockOpenMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
...
func (r *EditorIRRenderer) renderMathBlock(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.renderDivNode(node)
	} else {
		r.WriteString("</div>")
...
func (r *EditorIRRenderer) renderTableCell(node *ast.Node, entering bool) ast.WalkStatus {
	tag := "td"
...
func (r *EditorIRRenderer) renderTableRow(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("tr", nil, false)
	} else {
		r.Tag("/tr", nil, false)
...
func (r *EditorIRRenderer) renderTableHead(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
...
func (r *EditorIRRenderer) renderTable(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
...
func (r *EditorIRRenderer) renderStrikethrough(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.renderSpanNode(node)
	} else {
		r.Tag("/span", nil, false)
...
func (r *EditorIRRenderer) renderStrikethrough1OpenMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("span", [][]string{{"class", "editor-ir__marker"}}, false)
		r.WriteString("~")
		r.Tag("/span", nil, false)
...
func (r *EditorIRRenderer) renderStrikethrough1CloseMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("/s", nil, false)
		r.Tag("span", [][]string{{"class", "editor-ir__marker"}}, false)
		r.WriteString("~")
...
func (r *EditorIRRenderer) renderStrikethrough2OpenMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("span", [][]string{{"class", "editor-ir__marker"}}, false)
		r.WriteString("~~")
		r.Tag("/span", nil, false)
...
func (r *EditorIRRenderer) renderStrikethrough2CloseMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("/s", nil, false)
		r.Tag("span", [][]string{{"class", "editor-ir__marker"}}, false)
		r.WriteString("~~")
...
func (r *EditorIRRenderer) renderLinkTitle(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		if ast.NodeLink == node.Parent.Type && 3 == node.Parent.LinkType {
			return ast.WalkContinue
		}

		r.Tag("span", [][]string{{"class", "editor-ir__marker editor-ir__marker--title"}}, false)
...
func (r *EditorIRRenderer) renderLinkDest(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		if ast.NodeLink == node.Parent.Type && 3 == node.Parent.LinkType {
			return ast.WalkContinue
		}
...
func (r *EditorIRRenderer) renderLinkSpace(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		if ast.NodeLink == node.Parent.Type && 3 == node.Parent.LinkType {
			return ast.WalkContinue
		}
...
func (r *EditorIRRenderer) renderLinkText(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		if ast.NodeImage == node.Parent.Type {
			...
			if 3 == node.Parent.LinkType {
				...
				r.Tag("span", [][]string{{"class", "editor-ir__link"}}, false)
			}
		}
		r.Write(node.Tokens)
		r.Tag("/span", nil, false)
...
func (r *EditorIRRenderer) renderCloseParen(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		if ast.NodeLink == node.Parent.Type && 3 == node.Parent.LinkType {
			return ast.WalkContinue
		}

		r.Tag("span", [][]string{{"class", "editor-ir__marker editor-ir__marker--paren"}}, false)
...
func (r *EditorIRRenderer) renderOpenParen(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		if ast.NodeLink == node.Parent.Type && 3 == node.Parent.LinkType {
			return ast.WalkContinue
		}
...
func (r *EditorIRRenderer) renderCloseBrace(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("span", [][]string{{"class", "editor-ir__marker editor-ir__marker--brace"}}, false)
...
func (r *EditorIRRenderer) renderOpenBrace(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("span", [][]string{{"class", "editor-ir__marker editor-ir__marker--brace"}}, false)
...
func (r *EditorIRRenderer) renderCloseBracket(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("span", [][]string{{"class", "editor-ir__marker editor-ir__marker--bracket"}}, false)
		r.WriteByte(lex.ItemCloseBracket)
		r.Tag("/span", nil, false)
...
func (r *EditorIRRenderer) renderOpenBracket(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("span", [][]string{{"class", "editor-ir__marker editor-ir__marker--bracket"}}, false)
		r.WriteByte(lex.ItemOpenBracket)
		r.Tag("/span", nil, false)
...
func (r *EditorIRRenderer) renderBang(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("span", [][]string{{"class", "editor-ir__marker"}}, false)
...
func (r *EditorIRRenderer) renderImage(node *ast.Node, entering bool) ast.WalkStatus {
...
func (r *EditorIRRenderer) renderLink(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.renderSpanNode(node)
	} else {
		r.Tag("/span", nil, false)
...
func (r *EditorIRRenderer) renderHTML(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.renderDivNode(node)
		tokens := bytes.TrimSpace(node.Tokens)
		r.WriteString("<pre class=\"editor-ir__marker--pre editor-ir__marker\">")
...
func (r *EditorIRRenderer) renderInlineHTML(node *ast.Node, entering bool) ast.WalkStatus {
	if !entering {
		return ast.WalkContinue
	}
	...
	if openKbd || closeKbd {
		if openKbd {
			if r.tagMatchClose("kbd", node) {
				r.renderSpanNode(node)
				r.Tag("code", [][]string{{"class", "editor-ir__marker"}}, false)
				r.Write(html.EscapeHTML(node.Tokens))
				r.Tag("/code", nil, false)
				r.Tag("/span", nil, false)
				r.Tag("kbd", nil, false)
...
func (r *EditorIRRenderer) tagMatchClose(tag string, node *ast.Node) bool {
...
func (r *EditorIRRenderer) tagMatchOpen(tag string, node *ast.Node) bool {
...
func (r *EditorIRRenderer) renderDocument(node *ast.Node, entering bool) ast.WalkStatus {
	return ast.WalkContinue
}

func (r *EditorIRRenderer) renderParagraph(node *ast.Node, entering bool) ast.WalkStatus {
...
func (r *EditorIRRenderer) renderText(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		tokens := node.Tokens
...
func (r *EditorIRRenderer) renderCodeSpan(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.renderSpanNode(node)
	} else {
		r.Tag("/span", nil, false)
...
func (r *EditorIRRenderer) renderCodeSpanOpenMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("span", [][]string{{"class", "editor-ir__marker"}}, false)
...
func (r *EditorIRRenderer) renderCodeSpanContent(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Write(html.EscapeHTML(node.Tokens))
	}
	return ast.WalkContinue
...
func (r *EditorIRRenderer) renderCodeSpanCloseMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("/code", nil, false)
		r.Tag("span", [][]string{{"class", "editor-ir__marker"}}, false)
...
func (r *EditorIRRenderer) renderEmphasis(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.renderSpanNode(node)
	} else {
		r.Tag("/span", nil, false)
...
func (r *EditorIRRenderer) renderEmAsteriskOpenMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("span", [][]string{{"class", "editor-ir__marker editor-ir__marker--bi"}}, false)
...
func (r *EditorIRRenderer) renderEmAsteriskCloseMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("/em", nil, false)
		r.Tag("span", [][]string{{"class", "editor-ir__marker editor-ir__marker--bi"}}, false)
		r.WriteByte(lex.ItemAsterisk)
...
func (r *EditorIRRenderer) renderEmUnderscoreOpenMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("span", [][]string{{"class", "editor-ir__marker editor-ir__marker--bi"}}, false)
...
func (r *EditorIRRenderer) renderEmUnderscoreCloseMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("/em", nil, false)
		r.Tag("span", [][]string{{"class", "editor-ir__marker editor-ir__marker--bi"}}, false)
		r.WriteByte(lex.ItemUnderscore)
...
func (r *EditorIRRenderer) renderStrong(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.renderSpanNode(node)
	} else {
		r.Tag("/span", nil, false)
...
func (r *EditorIRRenderer) renderStrongA6kOpenMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("span", [][]string{{"class", "editor-ir__marker editor-ir__marker--bi"}}, false)
		r.WriteString("**")
		r.Tag("/span", nil, false)
...
func (r *EditorIRRenderer) renderStrongA6kCloseMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
...
func (r *EditorIRRenderer) renderStrongU8eOpenMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("span", [][]string{{"class", "editor-ir__marker editor-ir__marker--bi"}}, false)
		r.WriteString("__")
		r.Tag("/span", nil, false)
...
func (r *EditorIRRenderer) renderStrongU8eCloseMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("/strong", nil, false)
		r.Tag("span", [][]string{{"class", "editor-ir__marker editor-ir__marker--bi"}}, false)
		r.WriteString("__")
...
func (r *EditorIRRenderer) renderBlockquote(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
...
func (r *EditorIRRenderer) renderBlockquoteMarker(node *ast.Node, entering bool) ast.WalkStatus {
	return ast.WalkContinue
}

func (r *EditorIRRenderer) renderHeading(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		text := r.Text(node)
		...
		if strings.Contains(text, editor.Caret) || (nil != headingID && bytes.Contains(headingID.Tokens, editor.CaretTokens)) {
			r.WriteString("<h" + headingLevel[node.HeadingLevel:node.HeadingLevel+1] + " data-block=\"0\" class=\"editor-ir__node editor-ir__node--expand\"")
		} else {
			r.WriteString("<h" + headingLevel[node.HeadingLevel:node.HeadingLevel+1] + " data-block=\"0\" class=\"editor-ir__node\"")
		}
		...
		if r.Options.HeadingAnchor {
			id := HeadingID(node)
			r.Tag("a", [][]string{{"id", "editorAnchor-" + id}, {"class", "editor-anchor"}, {"href", "#" + id}}, false)
			r.WriteString(`<svg viewBox="0 0 16 16" version="1.1" width="16" height="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg>`)
			r.Tag("/a", nil, false)
		}

		if !node.HeadingSetext {
			r.Tag("span", [][]string{{"class", "editor-ir__marker editor-ir__marker--heading"}, {"data-type", "heading-marker"}}, false)
			r.WriteString(strings.Repeat("#", node.HeadingLevel) + " ")
			r.Tag("/span", nil, false)
		}
	} else {
		if node.HeadingSetext {
			r.Tag("span", [][]string{{"class", "editor-ir__marker editor-ir__marker--heading"}, {"data-type", "heading-marker"}, {"data-render", "2"}}, false)
			r.Newline()
...
func (r *EditorIRRenderer) renderHeadingC8hMarker(node *ast.Node, entering bool) ast.WalkStatus {
	return ast.WalkContinue
}

func (r *EditorIRRenderer) renderHeadingID(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("span", [][]string{{"data-type", "heading-id"}, {"class", "editor-ir__marker"}}, false)
		r.WriteString(" {" + string(node.Tokens) + "}")
		r.Tag("/span", nil, false)
	}
	return ast.WalkContinue
...
func (r *EditorIRRenderer) renderList(node *ast.Node, entering bool) ast.WalkStatus {
	tag := "ul"
...
func (r *EditorIRRenderer) renderListItem(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		var attrs [][]string
		switch node.ListData.Typ {
		case 0:
...
func (r *EditorIRRenderer) renderTaskListItemMarker(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		var attrs [][]string
...
func (r *EditorIRRenderer) renderThematicBreak(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
...
func (r *EditorIRRenderer) renderHardBreak(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.Tag("br", nil, true)
	}
	return ast.WalkContinue
...
func (r *EditorIRRenderer) renderSoftBreak(node *ast.Node, entering bool) ast.WalkStatus {
	if entering {
		r.WriteByte(lex.ItemNewline)
	}
	return ast.WalkContinue
...
func (r *EditorIRRenderer) renderSpanNode(node *ast.Node) {
	text := r.Text(node)
	var attrs [][]string
	...
	if strings.Contains(text, editor.Caret) {
		attrs = append(attrs, []string{"class", "editor-ir__node editor-ir__node--expand"})
	...
	attrs = append(attrs, []string{"class", "editor-ir__node"})
	r.Tag("span", attrs, false)
	return
}

func (r *EditorIRRenderer) renderDivNode(node *ast.Node) {
	text := r.Text(node)
...
func (r *EditorIRRenderer) Text(node *ast.Node) (ret string) {
