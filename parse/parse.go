...
type Options struct {
	...
	// Protyle 所见即所得支持。
	ProtyleWYSIWYG bool
	// InlineMathAllowDigitAfterOpenMarker 设置内联数学公式是否允许起始 $ 后紧跟数字 https://github.com/b3log/md/issues/38
	InlineMathAllowDigitAfterOpenMarker bool
	// Setext 设置是否解析 Setext 标题 https://github.com/pafthang/md/issues/50
	Setext bool
...
func NewOptions() *Options {
	return &Options{
		...
		EmojiSite:         "https://cdn.jsdelivr.net/npm/editor/dist/images/emoji",
		Setext:            true,
